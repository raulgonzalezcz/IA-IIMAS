% Open a file: consult('/home/raul/Escritorio/IA/Project1/change_KB1.pl').
...
abrir(KB):-
	open_kb('/home/raul/Escritorio/IA/Project1/KB.txt',KB),
	write('\nReading actual data...'),
	write('\nKB: '),
	write(KB).
...
deleteAllElementsWithSameProperty(X,[P],[H|N]):-
	deleteAllElementsWithSameProperty(X,P,[H|N]).
